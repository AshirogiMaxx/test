...
void printMonth(int month)
{
  switch(month)
  {
    case 1: oled.putString("Jan ");break;
    case 2: oled.putString("Feb ");break;
    case 3: oled.putString("Mar ");break;
    case 4: oled.putString("Apr ");break;
    case 5: oled.putString("May ");break;
    case 6: oled.putString("Jun ");break;
    case 7: oled.putString("Jul ");break;
    case 8: oled.putString("Aug ");break;
    case 9: oled.putString("Sep ");break;
    case 10: oled.putString("Oct ");break;
    case 11: oled.putString("Nov ");break;
    case 12: oled.putString("Dec ");break;
    default: oled.putString("--- ");break; //Display dashes if error - avoids scrambling display
  } 
}
...
void printDay(int day)
{
  switch(day)
  {
    case 1: oled.putString("Mon ");break;
    case 2: oled.putString("Tue ");break;
    case 3: oled.putString("Wed ");break;
    case 4: oled.putString("Thu ");break;
    case 5: oled.putString("Fri ");break;
    case 6: oled.putString("Sat ");break;
    case 7: oled.putString("Sun ");break;
    default: oled.putString("--- ");break; //oled dashes if error - avoids scrambling display
  } 
}
...
void setup()
{
  ...
  Wire.begin();	
  pinMode(12, INPUT);
  digitalWrite(8, HIGH); // ENABLE PULLUPS
...
void loop()
{
  ...
  if (mode <= 7){
    oled.setTextXY(64, 0);
    oled.putString(tempF);
    //oled.drawCircle(124, 8, 2, WHITE);
